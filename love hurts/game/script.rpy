...
define gf = Character("Gali", color="#e8d684")
define c = Character("Carl", color="#df9457")
define server = Character("Server", color="#F5F5DC")
define ex = Character("Jasper",color="#FFC5D3")
...
label bagpack:
    ...
    #TODO: in bagpack, add text to say hover to read, click to pack
...
#rakaPub in progress
    ...
    show pubserver
    "The two of you enter The Local Pub, a kind server greets you and asks how you are doing."

    "You had initially thought that you would be able to take a moment to talk to Raka but they just push ahead, ignoring the server and moving quickly towards their friends. You shoot her an apologetic glance and follow after your partner."
    
    "Your heart sinks as you realise, once again, that you will not get to have conversation you feel you both need."
    ...
    show rakafriend: 
        xpos 0.2 ypos 0.22 xzoom -1
    
    show raka proud hands:
        xpos 0.4 ypos 0.14

    show dori thinking: 
        xpos 0.7 ypos 0.15
    
    "Raka introduces you to the group. They ask you to join in their game of beer pong."
...
label joinpong: 
    ...
    "You’re nervous but you do want to participate. You find yourself grabbing the nearest drink and chugging it. It’s stronger than you thought it would be."
    
    thought "This is so nerve-wracking! I need something to help me chill out."
    
    hide dori happyzoom

    show dori scared zoom:
        xpos -0.032 ypos -0.045 

    "You try to focus on the cups in front of you to aim but you are not able to. You miss all the shots you take."

    thought "OMG! What’s happening to me? This is so embarrassing."

    scene pubbgleft
    "At first, Raka and their friends are sweet about it but as you continue to struggle you can sense the group getting tired of you. You see a couple of them roll their eyes at each other."
    ...
    "In an attempt to recover, you make a daring shot which ends up knocking over a few cups and spilling the drinks all over the table and floor."
     
    "Raka is not happy. They grab your arm roughly and move you away from the table."
    
    ra "Get it together, Dori. You’re acting so immature. It’s really embarrassing!"
...
label refusepong:
    scene pubbgright
    show dori uncomfortable:
        xpos 0.2 ypos -0.1 zoom 1.6

    "You’re nervous, so you opt to sit and watch instead."
    
    do "Thanks but I think I’m good. I like watching you guys play more anyway!"
    
    hide dori uncomfortable

    scene pubbgleft
    "As the game goes on, you overhear Raka’s friends talking about you."

    "They have usch a weird vibe."

    "Yeah, I think they're kind of a loser."

    "OMG, don't say that - that's so rude."

    "Sorry, it's just the truth. Like, they're just sitting there."

    scene pubbg
    show raka shock 1:
        xpos 0.2 ypos 0.2 zoom 0.95

    show rakafriend: 
        xpos 0.1 ypos 0.22 xzoom -1
    ...
    show server shock: 
        xpos 0.5 ypos 0.28
    "You feel sad and small. You down your drink and order another. You feel like you’re going to vomit."
    
    "You stand up quickly and as you do, you bump into a server with a large tray of drinks. Glasses crash all over the floor."
    
    scene pubzoom 
    show raka angry:
        xpos 0.1 ypos 0.15 zoom 0.9
    
    show dori shocked: 
        xpos 0.55 ypos 0.15
    "Raka comes over to you, grabs your arm roughly and pulls you to the side."
    ra "Get it together, Dori. You’re being really immature. It’s really embarrassing!"
    
    hide raka angry
    jump pubcrashout

label pubcrashout:
    show dori furious portrait: 
        xpos 0.2 ypos 0.0

    "You feel your cheeks blush with rage and shame. You yank your arm away from Raka."
    
    do "YOU are the one who should feel ashamed! All you’ve done this whole trip is make me feel like an idiot. Like you’re better than me. Well, you’re not! You’re selfish and mean and I don’t want to be around you or your snobby friends."

    scene pubbg zoom
    show raka shock 1:
        xpos 0.6 ypos 0.2 zoom 0.95
    ...
    show server shock: 
        xpos 0.4 ypos 0.28
    "Quite a few people are looking at your table now. A server has come to help clean up the mess. Raka tries to take you aside."
    ...
    show dori sad: 
        xpos 0.55 ypos 0.15
    ra "What the hell is wrong with you? You’re making a scene. I can’t be seen with someone acting the way you are. Go clean yourself up and come back when you’re ready to act like an adult."

    scene washroombg
    show dori crying:
        xpos 0.53 ypos 0.15
    "You walk quickly to the bathroom, holding back tears. They come flooding down your face once you’re alone."

    show dori crying: 
        xpos 0.22 ypos -0.1 zoom 1.6
...
label pubwizardchat:
    ...
    show dori sad: 
        xpos 0.53 ypos 0.15
    "You pull out your phone and contact the Local Wizard."
    "Wizard Chat to be soon!"
...
label pubyourself:
    ...
    show pub star:
        xpos -0.05 ypos 0.0
    "You decide you are capable of handling the situation alone. You take a moment to breathe and calm yourself down, holding your Star. You walk to an empty booth near the bar."
    "Click on things around that help orient your senses - what can you see, hear, touch, smell or taste around you?"
...
label pubtalk:
    ...
    show dori ashamed:
        xpos 0.33 ypos 0.15
    "You realize you will need to talk to Raka openly and honestly. You prepare yourself for a hard conversation, turning to leave."
    
    show server: 
        xpos 0.2 ypos 0.3
    show dori tired 2:
        xpos 0.5 ypos 0.2 zoom 0.95
    "As you’re leaving, the server you spilled drinks on walks into the booth."

    do "I am so sorry! I'm really so so sorry."

    "Hey, it's okay. It happens. Thank you for apologizing though, not everybody does. Are you okay, by the way?"
...
label pubtalking: 
    ...
    "You notice how shaken up you feel; how anxious."   
    do """Honestly, I’m a bit shaken up. But I’ll be alright in a bit."""
    "Listen, I don’t mean to pry into your personal business but I don’t think it was okay that that person grabbed you."
    do "I was overreacting, to be fair."
    
    scene pubbg zoom
    
    show server shock:
        xpos 0.33 ypos 0.2 zoom 1.5
    "You really weren’t. You just made a mistake. I’m only saying this because I know what it’s like."
    do "What do you mean?"
    " I used to be with someone who wasn’t good to me. They were rude to me in front of others, they were rough with me. Let me be honest, it doesn’t get better."
    ...
    show dori shocked: 
        xpos 0.5 ypos 0.2
    "You hold the person’s hand and they hold yours too."
    do "I’m sorry that happened to you."
    "Thanks for saying that. I’m in a much better place now."
    do "How did you leave?"
    "I asked for help and I decided that I deserved better. You do too."

    "You thank this stranger for talking with you. You feel seen in a way you haven’t before."

    show pubbgright


## Wizard Chat not established
## not done yet
...
label thelocalpub:
    ...
    "You finally meet Raka's friends. They have a secluded booth. Both of them are dressed in expensive and pristine adventuring gear."
    
    "You feel uncomfortable in your worn-in clothes. They welcome Raka with a smile and only glance at you."
    hide dori thinking
    hide rakafriend2
    hide rakafriend
    ...
    show rakafriend2 irritated:
        xpos 0.02 ypos 0.15 
    
    show rakafriend irritated:
        xpos 0.2 ypos 0.22 xzoom -1

    "You smile politely and try to join in the conversation. You ask what they do for work but they all just look at each other and chuckle over their drinks."
    
    show raka snide 2:
        xpos 0.4 ypos 0.14

    ra "Babe, my job is getting wasted in as many countries as I can."
    
    "You don’t think you will have anything in common with Raka’s friends but you keep that to yourself."
    
    transform move_offscreen_right:
        xalign 0.5
        linear 1.0 xalign 1.5

    # Use the transform to move Raka off the screen
    show raka snide 2 at move_offscreen_right

    "Raka leaves you to go order another round of drinks for the table. You’re nervous about being left alone."
    
    hide rakafriend irritated
    show rakafriend: 
        xpos 0.2 ypos 0.22 xzoom -1

##define friend 1, 2
    c "So you're Raka's favourite new catch huh?"
    
    gf "Isn’t it nice to feel so prized?"

    c "Many people would want to be you."

    gf "Isn't it great to have someone who takes charge? You probably don't have to do anything."
    ...
    show raka eyeroll at move_right:
        xpos 0.4 ypos 0.14 xzoom -1

    show dori thinking: 
        xpos 0.7 ypos 0.15

    "Before you have the time to answer, Raka returns with drinks. The group turns their energy to someone else - a person who just walked into the bar. Everyone raises their eyebows and looks to Raka."   
    
    "Well, well, well. Look who just waltzed in."

    show rakafriend2 irritated: 
        xpos 0.02 ypos 0.15 xzoom -1

    "Ugh, she’s so full of herself."

    "The person who walked in doesn’t seem to even have noticed your table."

    "Bet she’s here to make you look bad again, Raka."

    "I can't believe you actually dated her."

    "And who wears stripes any more? Like are you five?"
    ...
    menu:
        "Say something mean to feel included":
            jump thelocalpub1
...
label thelocalpub1: 
    ...
    do "Guess they're letting anbody in these days."
    ...
    "Raka shoots you an amused and judgmental look."

    ra "Says the person on their first adventure alone. Right, Dori?"
   
    show rakafriend at Transform(xpos=0.2, ypos=0.22, xzoom=1)

    "Raka’s friends all laugh and you feel your cheeks getting hot. You were just trying to fit in." 

    "Embarrassed, you excuse yourself and run to the bathroom."
    jump pubwashroom
...
label thelocalpub2:
    ...
    do "I think she's honestly just minding her own business guys."
    ...
    ra " Oh my god, Dori, nobody likes a buzzkill."

    "Raka’s friends all laugh and you feel your cheeks getting hot. You were just trying to do something." 
   
    "Embarrassed, you excuse yourself and go to the bathroom."
    jump pubwashroom
##caila
...
label pubwashroom: 
    ...
    show dori crying: 
        xpos 0.53 ypos 0.15
    "Tears begin streaming down your face. You’re still sobbing when a familiar face enters the bathroom."

    show jasper thoughtful with dissolve:
        xpos 0.2 ypos 0.25
    
    show dori sad with dissolve:
        xpos 0.53 ypos 0.15    

    "It’s Raka’s ex. They take some tissues out of the dispenser and hand them to you."

    "Ex: Hey, I saw you run away from that group. Did they say something to you?"

    do "I- I just don’t fit in with them."

    "Ex: No, they go out of their way to make you feel excluded. They’re also a bunch of liars. You shouldn’t believe everything they say."
    
    scene washroomzoom

    show dori shockedzoom with dissolve:
        xpos 0.23 ypos 0.0
    do " Wait, what do you mean?"

    scene washroombg
    show dori thinking:
        xpos 0.53 ypos 0.15
    
    show jasper thoughtful:
        xpos 0.2 ypos 0.25
    "Well, they do whatever Raka says. And Raka is not a very nice person. We used to go out and we’ve done a few adventures." 
    
    do "How were they?"
    
    "Ex: We only had a good time when I let Raka decide what to do. But if I ever resisted too much... They show you a cracked watch."

    do "They did that?"
    
    "Ex: Yeah, slammed it on the ground when I told them I didn’t want to be around them anymore."
    ...
    "I’m in a much better place now. I just wanted to reach out to you because you seemed distressed when you ran in here."

    do "I was...they’re just really hard to please."

    "Honestly, you're better off without them. I'm Japser btw hahaha."

    do "Hi Jasper, nice to meet you! You are not at all like how they said you'd be."
   
    "Most people aren't. That group can be quite shallow. Look, I gotta go but I hope you do what's best for you."
    
    pause

    scene washroomzoom
    show dori ashamed:
        xpos 0.25 ypos 0.0 zoom 1.6
    "After Jasper leaves, you stay in the bathroom for a little longer. You exist feeling a little anxious. Raka is standing outside."
    jump outsidewashroom

label outsidewashroom:
    scene pubzoom 
    show dori thinking:
        xpos 0.55 ypos 0.15
    ...
    ra " Hey, you doing alright in there?"
    do 'Yeah, I just -'
    ra "Here, I broguht you some lemon water. Yes, tell me."
    do "Thanks... I just="
    do "I just had a strange encounter."
    
    show dori shocked: 
        xpos 0.55 ypos 0.15
    ra "Yeah, I saw Jasper coming out of the restroom - have they been spreading rumors about me again? They’re crazy, Dori - a compulsive liar and a bit of a drama queen. It was a big problem actually while we were together."
    
    do "Wait, really?"

    ra "Don’t even get me started - they even broke their own watch and tried to pass it off as something I did."
    do "Oh..."
    ra "Why don’t we get out of here? I know a place we can go to be alone and sort this all out."

    show dori thinking: 
        xpos 0.25 ypos -0.05 zoom 1.3
    
    hide raka normal

    menu:
        "Believe Jasper's warning":
            jump believejasper
...
label believejasper:
    ...
    show dori ashamed:
        xpos 0.55 ypos 0.15
    "You search for the right words. You’re nervous but you know what to do."
    
    do " I don't know, Raka. I haven’t really been feeling great about the way you’ve been treating me. I’ve think that I need to be on my own for now."
    show raka angry: 
        xpos 0.1 ypos 0.15 zoom 0.8
    ra "You got all this from crying in the bathroom? You didn’t think you should talk to me first?"
    do " I can’t exactly have this conversation with you in front of your friends."
    ra "You're a corward, Dori."
    do "I'm sorry you're not taking this weel."
    ra "Don't expect me to do anything when you come crawling back."
    
    "You had suspected Raka wouldn’t take it well but you didn’t expect them to act this way. As you make a quick exit, you manage to grab your bag back!"
    jump echolake

label believeraka:
    scene pubbgforex
    show raka normal:
        xpos -0.15 ypos 0.15 xzoom -1.0

    show dori ashamed:
        xpos 0.32 ypos 0.15
        
    "Out of guilt, you agree. After all you barely know anything else about Jasper. Raka grabs your bag and the two of you head out."
    jump isolationcave
...
label echolake:
    ...
    show echolaketitle:
        xpos 0.3 ypos 0.43
    pause
    scene echolake reflection
    diary "I am resting. There is a beautiful shimmering lake in front of me. It's so still that I can see my reflection in it. I feel both peace and sadness. I think there will be things from this journey that I will have to reflect on for a long time."
    diary "But I am actually glad to be alone; to feel the comfort of my own company. I'm enjoying taking my time, nobody rushing me. I can enjoy this lake. I can rest. I can actually breathe. I am proud of myself."

    scene echolake fossilbg
    show fossil:
        xpos 0.0 ypos 0.0
    "As you sit by the shore of the lake, taking in the stillness, you notice something glittering in the pool. It's not too deep, you wouldn't have to swim. Your curiosity piqued, you take off your shoes, roll up your pants and wade in. The water is cool and soothing against your skin."
    hide fossil

    show fossil clear with dissolve:
        xpos 0.0 ypos 0.0
    "You bend and grab the glittering object. Your fingers close around a smooth, round stone. You turn it over and gasp. Embedded in the stone is the imprint of an ancient plant. A fossil!"

    scene echolakebg
    show dori thinking: 
        xpos 0.5 ypos 0.15

    "On the shore, your phone buzzes. It's a message from Shilo."
    sh "{i}Hey kid. Just ran into someone who knew this Raka character. They seem to have a reputation for being a bully."
    sh "{i}And, based on what you’ve told me, seems like that’s true. I’m  sorry you had to deal with all that and hope you're okay. Excited to see you when you get home! Love ya!"
    "You find yourself beaming widely as you read the message. You respond by telling Shilo that you and Raka are no longer journeying together."
    "{i}OMG fantastic news!{/i}, they text."
    "You pack up your gear, all your rocks and your fossil safely tucked into your pack."
    
    show dori happy: 
        xpos 0.5 ypos 0.15 zoom 1.05
    "You are happy."

    show dori thinking: 
        xpos 0.5 ypos 0.15 zoom 1.00
    "You have a feeling that Raka might come looking for you, though. You think that maybe you should leave a text or something before you call the journey over."
       
    "Suddenly, a flash of light blinds you!"
    "An elderly sage in an elaborate robe appears before you. They seem to have a familiar face."
    ...
    show dori shocked: 
        xpos 0.5 ypos 0.15
    "An elderly sage in an elaborate robe appears before you. They seem to have a familiar face." 
    es "Apologies for scaring you, young one!"
    es "I am the Eternal Sage of Emoterra. I guard these terrains and keep a note of everyone who passes through them."
    
    show dori happy: 
        xpos 0.5 ypos 0.15
    do "Oh yes! The Eternal Sage! Shilo had told me of you."
    
    es " I’ve heard a fair bit about you too, Dori. My network of wizards keep me posted."
    es "Congratulations on braving the changes of these lands. I hear you are now at the end of you journey."
    
    show dori uncomfortable: 
        xpos 0.5 ypos 0.15
    do "Yeah, it’s been...wild."

## in storyboard: *one line about Dori realising they are alone?*
   
    es "I appear before you because I have one last choice for you."
    do "Okay!"
    es "I want to give you a fresh start, a priceless gift if you will - my Time Machine."
    es "Should you accept, you have the opportunity to replay your journey with Raka, revisit pivotal moments and make choices differently this time." 
    es "Keep in mind however - you could end up in a place much better or even worse than this!"
    
    show dori thinking: 
        xpos 0.5 ypos 0.15
    "You think about this new information - this new gift the Sage has presented."
    "Perhaps a different choice could have led you to a happier journey with Raka after all. You can’t stop thinking of the possibilities. But the idea of going home to Shilo is tempting too. What will you choose?"
    ...
    menu:
        ...
        "Use the Time Machine and start again":
            return
...
label localPub2:
    ...
    {w}But remember, it not about keeping score of who does how much! {w} Give with an open heart, and ask for what you want. A good partner will do the same for you."
